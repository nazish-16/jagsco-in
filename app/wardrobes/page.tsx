    ...
    return (
        <div className='background-new h-96 md:h-80'>
            ...
            <div className='flex flex-col md:flex-row items-center justify-center p-16 md:p-28'>
                <div>
                    <img src='https://img.icons8.com/?size=100&id=8462&format=png&color=ffffff' alt="#" className='w-28 h-28 md:w-28 md:h-28 mr-0 md:mr-20 lg:mr-10' />
                </div>
                <div className='flex flex-col'>
                    <h1 className='text-3xl sm:text-4xl text-[#cfcfcf] font-medium tracking-tighter text-center m-5 md:text-start'>Wardrobes</h1>
