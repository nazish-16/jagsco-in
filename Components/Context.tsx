    ...
    return (
        <div id='context' className='items-center justify-center flex'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-6'>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center rounded-lg m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700'>Jagsco Marble specializes in providing high-quality marble for various interior design needs.</p>
                </div>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700'>Our modular kitchen designs emphasize elegance, practicality, and innovation. By integrating high-quality marble.</p>
                </div>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700'>Our modular wardrobe designs focus on elegance, functionality, and customization. By integrating premium marble.</p>
                </div>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700  m-1'>Seamlessly incorporating modern appliances such as built-in ovens, refrigerators, dishwashers, and induction cooktops into the kitchen design.</p>
                </div>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700'>high-quality marble with premium accessories, offering luxurious and functional spaces tailored to your needs.</p>
                </div>
                <div className='flex flex-col mt-10 2xl:mt-0 2xl:p-10 items-center justify-center m-1 transition'>
                    ...
                    <p className='max-w-sm 2xl:max-w-lg text-center text-md text-gray-700'>We offer a variety of different types of Luxurious home decor with premium marble accents.</p>
                </div>
            </div>
        </div>
    )
