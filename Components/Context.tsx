        ...
        <div id='context' className='items-center justify-center flex'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6'>
                <div className='flex flex-col p-10 items-center justify-center rounded-lg m-1 transition'>
                    <Image src={type1} alt="" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-2xl text-[#205980] font-normal tracking-wider text-center'>Interior Designing</h1>
                ...
                <div className='flex flex-col p-10 items-center justify-center m-1 transition'>
                    <Image src={type2} alt="#" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-2xl text-[#205980] font-normal tracking-wider text-center'>Modular Kitchens</h1>
                ...
                <div className='flex flex-col p-10 items-center justify-center m-1 transition'>
                    <Image src={type3} alt="#" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-2xl text-[#205980] font-normal tracking-wider text-center'>Wardrobe</h1>
                ...
                <div className='flex flex-col p-10 items-center justify-center m-1 transition'>
                    <Image src={typpe4} alt="#" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-2xl text-[#205980] font-normal tracking-wider text-center'>Appliances</h1>
                ...
                <div className='flex flex-col p-10 items-center justify-center m-1 transition'>
                    <Image src={type5} alt="#" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-[23px] text-[#205980] font-normal tracking-wider text-center'>Accessories</h1>
                ...
                <div className='flex flex-col p-10 items-center justify-center m-1 transition'>
                    <Image src={type6} alt="#" className='w-[130px] h-[130px] lg:w-[170px] lg:h-[170px] rounded-full hover:scale-105 transition-all cursor-pointer' />
                    <h1 className='p-4 text-[23px] text-[#205980] font-normal tracking-wider text-center'>Home Decor</h1>
